...
#ifndef V_BUSITEM_PROXY_H_1421836289
#define V_BUSITEM_PROXY_H_1421836289
...
public Q_SLOTS: // METHODS
    ...
    inline QDBusPendingReply<QString> GetDescription(const QString &language, int length)
    {
        QList<QVariant> argumentList;
        argumentList << QVariant::fromValue(language) << QVariant::fromValue(length);
