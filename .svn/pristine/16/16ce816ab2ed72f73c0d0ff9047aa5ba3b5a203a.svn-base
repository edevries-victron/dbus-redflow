...
class VBusItem : public QObject
{
	...
	Q_PROPERTY(QVariant description READ getDescription NOTIFY descriptionChanged)
...
public:
	...
	QString getText();
	QString getDescription(const QString &language = "EN", int length = 0);
	int setDescription(const QString& language, QString& description);
	QVariant getMin();
	QVariant getMax();
	QVariant getDefault();
