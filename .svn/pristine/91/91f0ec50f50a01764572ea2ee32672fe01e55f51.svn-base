...
QString VBusItemPrivateProd::qGetDescription(const QString &language, int length)
{
	Q_UNUSED(language)
	Q_UNUSED(length)
...
int VBusItemPrivateProd::qSetDescription(const QString &language, const QString &description)
{
	Q_UNUSED(language)
