...
QString VBusItem::getDescription(const QString &language, int length)
{
	Q_D(VBusItem);
	...
	return d->qGetDescription(language, length);
}

int VBusItem::setDescription(const QString& language, QString& description)
{
	Q_D(VBusItem);
	...
	return d->qSetDescription(language, description);
}
