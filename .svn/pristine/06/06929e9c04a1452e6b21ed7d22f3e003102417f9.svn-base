...
// Add a description of the changes to CHANGELOG.txt with the new number.
...
#error it is time to read CHANGELOG.txt
#endif
...
#endif
/*
 * See doc/README_interrupts.txt. By default a single context is assumed
