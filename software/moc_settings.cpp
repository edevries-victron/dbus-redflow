...
**
** Created: Tue Jul 28 05:44:20 2015
...
static const char qt_meta_stringdata_Settings[] = {
    "Settings\0\0deviceIdsChanged()\0QStringList\0"
    "deviceIds\0"
};
...
void Settings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->deviceIdsChanged(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
int Settings::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QStringList*>(_v) = deviceIds(); break;
        }
        _id -= 1;
    } else if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: setDeviceIds(*reinterpret_cast< QStringList*>(_v)); break;
        }
        _id -= 1;
...
// SIGNAL 0
void Settings::deviceIdsChanged()
{
